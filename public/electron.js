...
const convertPolicyTypes = function convertConfigurationPolicyTypeValues(json) {
  ...
  for (orgProperty in convertedJson.channel_group.groups.Application.groups) {
    const org = convertedJson.channel_group.groups.Application.groups[orgProperty];
  ...
  for (orgProperty in convertedJson.channel_group.groups.Orderer.groups) {
    const org = convertedJson.channel_group.groups.Orderer.groups[orgProperty];
